...
best_student = Student('Сергей', 'Смелов', 'мужчина')
best_student.courses_in_progress += ['Python', "Git"]
best_student.finished_courses += ['Вводный курс по программированию']
best_student.rate(some_lecturer, 'Python', 10)

some_reviewer = Reviewer('Адилет', 'Асанкожоев')
...
print("")
print("Обычный студент имеет оценки ниже, чем лучший?")
